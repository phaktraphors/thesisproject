...
import 'package:kate_botique_app/screen/payment_screen.dart';
import 'package:kate_botique_app/services/shipping_service.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void _shipping(BuildContext context, Shipping shipping) async {
    ...
    if (result['result'] == true) {
      ...
      _showSnackMessage(Text('Error to add shipping', style: TextStyle(color: Colors.red),));
    }
  }
}
